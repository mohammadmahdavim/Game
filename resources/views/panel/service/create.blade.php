        ...
        <div class="card-body">
            ...
            <form method="POST"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label>Title:</label>
                        <input class="form-control" type="text" name="title" value="{{ old('title', $service->title ?? '') }}"><br>
                    </div>
                    <div class="col-md-12">
                ...
                <button type="submit" class="btn btn-success btn-block">{{ isset($service) ? 'Update' : 'Create' }}</button>
            </form>
        </div>
    </div>
@endsection
